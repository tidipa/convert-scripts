  ...
  <main class="d-flex flex-nowrap" >
    <div class="flex-shrink-0 p-3 overflow-scroll" style="width: 300px;">
      <a href="/" class="d-flex align-items-center pb-3 mb-3 link-body-emphasis text-decoration-none border-bottom">
        <img src="/images/logo48.png" alt="Tipitaka2500" id="bootstrap" width="24" />
              ...
              <li class="mb-1 ms-3">
                ...
                <div class="collapse" id="k-collapse">
                  <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    ...
                    <li><a href="/tipitaka/23Mn.html" class="link-body-emphasis d-inline-flex text-decoration-none rounded">Mahāniddesapāḷi</a></li>
